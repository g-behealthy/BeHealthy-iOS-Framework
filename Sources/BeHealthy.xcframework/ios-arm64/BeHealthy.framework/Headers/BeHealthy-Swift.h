...
typedef SWIFT_ENUM(NSInteger, BeHealthyActivationFlow, open) {
  BeHealthyActivationFlowEmail = 0,
  BeHealthyActivationFlowSms = 1,
};
...
- (void)setSDKConfigurationWithIsSDKConfiguration:(BOOL)isSDKConfiguration;
...
@interface UICollectionViewFlowLayout (SWIFT_EXTENSION(BeHealthy))
...
@property (nonatomic) int32_t deactivationDays;
